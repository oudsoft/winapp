...
const doDownloadStudiesFromLocalOrthanc = function(studyID, dest){
	return new Promise((resolve, reject)=>{
		const orthancUrl = 'http://' + process.env.ORTHANC_IP + ':8042/studies/' + studyID + '/archive';
...
const doCallStudiesFromLocalOrthanc = function(){
	return new Promise((resolve, reject)=>{
		const orthancUrl = 'http://' + process.env.ORTHANC_IP + ':8042/studies';
		const userpass = "demo:demo";
		var options = {
	    method: 'GET',
	    headers: {
...
const doCallStudyFromLocalOrthanc = function(studyId){
	return new Promise((resolve, reject)=>{
		const orthancUrl = 'http://' + process.env.ORTHANC_IP + ':8042/studies/' + studyId;
		const userpass = "demo:demo";
		var options = {
	    method: 'GET',
	    headers: {
